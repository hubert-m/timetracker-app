        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <!-- Zadania w projekcie (Zaślepka) -->
                    <div class="bg-gray-800/40 backdrop-blur-md border border-gray-700/50 rounded-3xl p-8 shadow-xl">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-xl font-bold text-white">Zadania</h3>
                            <span class="px-3 py-1 bg-gray-700 text-xs font-semibold rounded-full text-gray-300">Wkrótce</span>
                        </div>
                        <div class="text-center py-8">
                            <p class="text-gray-500">Zadania dla tego projektu pojawią się w przyszłości.</p>
                        </div>
                    </div>
                </div>
